                ...
                <div className="xl:gap-[120px] flex justify-between xl:px-[60px] w-full">
                    <div className="flex flex-col items-center lg:gap-[20px] w-[31%]">
                        ...
                        <div className="relative w-[60%] aspect-square ">
                            <Image src={"/amico.png"} alt="connect" fill className=" object-contain" />
                        </div>
                    ...
                    <div className="flex flex-col xl:gap-[30px] lg:gap-[25px]">
                        ...
                        <button
                            type="submit"
                            className="flex justify-center items-center lg:rounded-[50px] font-semibold xl:text-[20px] lg:text-[18px] xl:w-[213px]  lg:w-[180px] bg-gradient-to-b from-[#C18830] to-[#976220] xl:px-[40px] xl:py-[20px] lg:px-[30px] lg:py-[15px] text-white border-2 border-transparent  cursor-pointer"
                            style={{
                                backgroundImage:
