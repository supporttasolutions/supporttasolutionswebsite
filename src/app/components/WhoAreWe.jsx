...
function WhoAreWe() {
  return (
    <section id="white-section" className="2xl:min-h-auto lg:min-h-screen w-full  flex items-center justify-center lg:py-[80px] min-h-[150vh] bg-white">
      <div className=" w-[83%] flex flex-col items-center justify-center lg:gap-[60px] xl:gap-[80px] container">
        ...
        <div className="flex justify-between   w-full  h-auto">
          ...
          <div
            className={`${whoWeAreStyle.imagediv} w-[53%] relative flex items-center justify-center`}
          >
            <Image
              src="/who-are-we.png"
              width={500}
