...
function Footer() {
  return (
    ...
    >
      <div className="flex flex-col lg:gap-[30px] xl:gap-[40px] lg:w-[83%] container font-[raleway]">
        <div className="flex justify-between w-full footerSection ">
          <div className="flex flex-col lg:gap-[25px] xl:gap-[30px] h-max">
            <div className="xl:text-[20px] lg:text-[18px]  font-semibold text-[#E08F34]">
              Resourses
            </div>
        ...
        <div className="flex justify-between lg:h-[116px]">
          <div className="flex flex-col justify-center lg:gap-[12px] xl:w-[180px] lg:w-[160px]">
            <div className="text-[#E08F34] xl:text-[20px] lg:text-[18px] inter tracking-[0.2em]">
              Follow us
            </div>
          ...
          <div className="flex justify-center items-center">
            <form className="flex items-center justify-center lg:gap-[20px]  lg:h-[40px]">
              ...
              <button
                type="submit"
                className="flex justify-center items-center lg:rounded-[50px] font-medium lg:w-[130px] bg-gradient-to-b from-[#C18830] to-[#976220] lg:p-[10px] cursor-pointer"
              >
                Let’s Connect
              </button>
            </form>
        ...
        <div className="flex justify-start items-center xl:text-[16px]w-full inter">
